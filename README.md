...
- *Libraries*: **OpenCV, NumPy, Pandas, Scikit-Learn, Matplotlib, TensorFlow, Keras**
- *DevOps*: **Amazon Web Services, Google Cloud Platform, Jenkins, CI/CD, TravisCI, Docker, Kubernetes**
- *Tools*: **Git, GitHub, GitLab, JIRA, Trello, VS Code, SonarQube, Jupyter** 
